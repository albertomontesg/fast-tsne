			...
			for (int iK = iB; iK < iB + B; iK += K) {
				for (int jK = jB; jK < jB + B; jK += K) {
					...
					if (iK == jK) {
						...
						__m512 Xn_0 = _mm512_set_ps(XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1], XnD[0], XnD[1]);
						__m512 Xn_1 = _mm512_set_ps(XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3], XnD[2], XnD[3]);
						__m512 Xn_2 = _mm512_set_ps(XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5], XnD[4], XnD[5]);
						__m512 Xn_3 = _mm512_set_ps(XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7], XnD[6], XnD[7]);
						__m512 Xn_4 = _mm512_set_ps(XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9], XnD[8], XnD[9]);
						__m512 Xn_5 = _mm512_set_ps(XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11], XnD[10], XnD[11]);
						__m512 Xn_6 = _mm512_set_ps(XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13], XnD[12], XnD[13]);
						__m512 Xn_7 = _mm512_set_ps(XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15], XnD[14], XnD[15]);

						__m512 Xm = _mm512_loadu_ps(XmD);

						__m512 diff_0 = _mm512_sub_ps(Xm, Xn_0);
						__m512 diff_1 = _mm512_sub_ps(Xm, Xn_1);
						__m512 diff_2 = _mm512_sub_ps(Xm, Xn_2);
						__m512 diff_3 = _mm512_sub_ps(Xm, Xn_3);
						__m512 diff_4 = _mm512_sub_ps(Xm, Xn_4);
						__m512 diff_5 = _mm512_sub_ps(Xm, Xn_5);
						__m512 diff_6 = _mm512_sub_ps(Xm, Xn_6);
						__m512 diff_7 = _mm512_sub_ps(Xm, Xn_7);

						__m512 diff_sq_0 = _mm512_mul_ps(diff_0, diff_0);
						__m512 diff_sq_1 = _mm512_mul_ps(diff_1, diff_1);
						__m512 diff_sq_2 = _mm512_mul_ps(diff_2, diff_2);
						__m512 diff_sq_3 = _mm512_mul_ps(diff_3, diff_3);
						__m512 diff_sq_4 = _mm512_mul_ps(diff_4, diff_4);
						__m512 diff_sq_5 = _mm512_mul_ps(diff_5, diff_5);
						__m512 diff_sq_6 = _mm512_mul_ps(diff_6, diff_6);
						__m512 diff_sq_7 = _mm512_mul_ps(diff_7, diff_7);

						__m256 diff_sq_0_low = _mm512_castps512_ps256(diff_sq_0);
						__m256 diff_sq_0_high = _mm512_extractf32x8_ps(diff_sq_0, 1);
						__m256 diff_sq_1_low = _mm512_castps512_ps256(diff_sq_1);
						__m256 diff_sq_1_high = _mm512_extractf32x8_ps(diff_sq_1, 1);
						__m256 diff_sq_2_low = _mm512_castps512_ps256(diff_sq_2);
						__m256 diff_sq_2_high = _mm512_extractf32x8_ps(diff_sq_2, 1);
						__m256 diff_sq_3_low = _mm512_castps512_ps256(diff_sq_3);
						__m256 diff_sq_3_high = _mm512_extractf32x8_ps(diff_sq_3, 1);
						__m256 diff_sq_4_low = _mm512_castps512_ps256(diff_sq_4);
						__m256 diff_sq_4_high = _mm512_extractf32x8_ps(diff_sq_4, 1);
						__m256 diff_sq_5_low = _mm512_castps512_ps256(diff_sq_5);
						__m256 diff_sq_5_high = _mm512_extractf32x8_ps(diff_sq_5, 1);
						__m256 diff_sq_6_low = _mm512_castps512_ps256(diff_sq_6);
						__m256 diff_sq_6_high = _mm512_extractf32x8_ps(diff_sq_6, 1);
						__m256 diff_sq_7_low = _mm512_castps512_ps256(diff_sq_7);
						__m256 diff_sq_7_high = _mm512_extractf32x8_ps(diff_sq_7, 1);
