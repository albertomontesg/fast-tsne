...
inline void blocking2(float* P, int N, float scale) {
	...
	for(n = 0; n < N; n+=8) {
		...
		for(m = n; m < N; m+=8) {
			...
			__m256 row0 = _mm256_load_ps(P+row0_index);
			__m256 row1 = _mm256_load_ps(P+row1_index);
			__m256 row2 = _mm256_load_ps(P+row2_index);
			__m256 row3 = _mm256_load_ps(P+row3_index);
			__m256 row4 = _mm256_load_ps(P+row4_index);
			__m256 row5 = _mm256_load_ps(P+row5_index);
			__m256 row6 = _mm256_load_ps(P+row6_index);
			__m256 row7 = _mm256_load_ps(P+row7_index);
			...
			__m256 col0 = _mm256_load_ps(P+col_index0);
			__m256 col1 = _mm256_load_ps(P+col_index1);
			__m256 col2 = _mm256_load_ps(P+col_index2);
			__m256 col3 = _mm256_load_ps(P+col_index3);
			__m256 col4 = _mm256_load_ps(P+col_index4);
			__m256 col5 = _mm256_load_ps(P+col_index5);
			__m256 col6 = _mm256_load_ps(P+col_index6);
			__m256 col7 = _mm256_load_ps(P+col_index7);
			...
			_mm256_store_ps(P+row0_index,row0_sum);	
			_mm256_store_ps(P+row1_index,row1_sum);	
			_mm256_store_ps(P+row2_index,row2_sum);	
			_mm256_store_ps(P+row3_index,row3_sum);	
			_mm256_store_ps(P+row4_index,row4_sum);	
			_mm256_store_ps(P+row5_index,row5_sum);	
			_mm256_store_ps(P+row6_index,row6_sum);	
			_mm256_store_ps(P+row7_index,row7_sum);

			_mm256_store_ps(P+col_index0,col0_sum);	
			_mm256_store_ps(P+col_index1,col1_sum);	
			_mm256_store_ps(P+col_index2,col2_sum);	
			_mm256_store_ps(P+col_index3,col3_sum);	
			_mm256_store_ps(P+col_index4,col4_sum);	
			_mm256_store_ps(P+col_index5,col5_sum);	
			_mm256_store_ps(P+col_index6,col6_sum);	
			_mm256_store_ps(P+col_index7,col7_sum);
