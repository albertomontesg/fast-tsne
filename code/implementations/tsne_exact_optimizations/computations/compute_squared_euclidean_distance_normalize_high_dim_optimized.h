#ifndef COMPUTE_SQUARED_EUCLIDEAN_DISTANCE_NORMALIZE_HIGH_DIM_OPTIMIZED_H
#define COMPUTE_SQUARED_EUCLIDEAN_DISTANCE_NORMALIZE_HIGH_DIM_OPTIMIZED_H
...
inline void compute_squared_euclidean_distance_normalize_high_dim_optimized(float* X, int N, int D, float* DD, float* mean) {
